...

{
  imports =
	...
	# Enable Home Manager and Base Profile
	../../modules/home/glue.nix

	# Home Manager Feature modules and profiles
		#Imported in glue.nix
    ];
   ...
   networking.hostName = "charles-vm"; # Define your hostname.
